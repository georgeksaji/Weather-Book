    ...
    @endif
      ...
      <div class="location">
        <form action="" method="post">
          @csrf
          <input type="text" id="city"  value="{{ $user_city }}" placeholder="Enter city name">
      ...
      @if ($cities->count() > 0)
        <pre>
        @foreach ($cities as $c)
            City: {{ $c->city_name }}, Country: {{ $c->country_name }}
        @endforeach
        </pre>
    @else
        <p>No cities found for this user.</p>
    @endif
